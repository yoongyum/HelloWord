...
export default function WordItem({ id, wordValue, meaningValue, checked, onCheck, onRemove }) {
    ...
    return (
        <Swipeable renderRightActions={rightSwipe} onSwipeableRightOpen={onRemove(id)}>
            <View style={styles.container}>
                ...
                <TouchableOpacity style={styles.EyesArea} onPressOut={onCheck(id)}>
                    {!checked ? <Image style={styles.EyeImage} source={EyeOff} resizeMode="contain" /> : <Image style={styles.EyeImage} source={EyeOn} resizeMode="contain" />}
                </TouchableOpacity>
            </View>
        </Swipeable>
    );
