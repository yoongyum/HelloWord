      ...
      <SafeAreaView style={styles.container}>
         ...
         <KeyboardAvoidingView behavior={Platform.OS === "ios" ? "padding" : "height"}>
            <View style={styles.container2}>
               ...
               <TextInput style={styles.InputArea} placeholder={"Please write the word"} onChangeText={vocaInputHandler} value={newWord} />
            </View>

            <View style={styles.container2}>
               <Text style={styles.Subject}>MEANING</Text>
               <TextInput style={styles.InputArea} placeholder={"Write the meaning of the word"} onChangeText={vocaInputHandler2} value={newMean} />
            </View>
