...
export default function StartScreen ({navigation, route}){
  ...
  //NextButton
  const NextWord=()=>{
    if(number == vocas.length) 
      alert('시험을 종료합니다.'),navigation.goBack();
    else {
  ...
  return (
     <SafeAreaView style={styles.container}>
        ...
        <View style={styles.container2}>
           <Text style={styles.Text}>{visible ? vocas[number - 1].meaningValue : vocas[number - 1].wordValue}</Text>
        </View>
        <View style={styles.container2}>
